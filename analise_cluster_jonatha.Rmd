...
Nesse relatório, encontra-se duas abordagens para algoritmos de agrupamentos, um hirárquico e um não hirárquico. Com a proposta de usar um banco de dados e simular uma clusterização, iremos definir os clusters com base na metodologia definida em sala de aula. E usaremos alguma métrica pra definir se o agrupamento foi feito de uma forma razoável.
